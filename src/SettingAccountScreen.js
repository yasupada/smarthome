          ...
          <View style={{ flex: 1, marginTop: 30 }}>
            ...
            >
              <View style={{ paddingTop: 0, width: "100%" }}>
                <Text style={{ fontSize: 16 }}>Username: Knight Prx</Text>
              </View>
              <Button
              onPress={() => {
            ...
            >
              <View style={{ paddingTop: 0, width: "100%" }}>
                <Text style={{ fontSize: 16 }}>Email: knight@gmail.com</Text>
              </View>
              <Button
              onPress={() => {
            ...
            >
              <View style={{ paddingTop: 0, width: "100%" }}>
                <Text style={{ fontSize: 16, paddingLeft: 35 }}>Use PIN On/Off</Text>
              </View>
              <Button
                buttonStyle={{
                  backgroundColor: "transparent",
