...
export default function SettingAccountScreen(props) {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Image style={{width: 100, height: 100}} source={require('./assets/custome/demo-profile.png')} />
          </View>
          <View style={{ flex: 1, marginTop: 30 }}>
            ...
            >
              <View style={{ paddingTop: 0, width: "100%" }}>
                <Text style={{ fontFamily: 'Inter_100Thin', fontSize: 16 }}>Username: Knight Prx</Text>
              </View>
              <Button
              onPress={() => {
                props.navigation.navigate("AccountUsernameSetting");
                console.log("Username Setting Press!");
              }}
                buttonStyle={{
                ...
                icon={
                  <Image
                    ...
                    source={require("./assets/custome/pen-edit.png")}
                  />
                }
                iconRight
                title={""}
            ...
            >
              <View style={{ paddingTop: 0, width: "100%" }}>
                <Text style={{ fontFamily: 'Inter_100Thin', fontSize: 16 }}>Password</Text>
              </View>
              <Button
              onPress={() => {
                props.navigation.navigate("AccountPasswordSetting");
                console.log("Password Setting Press!");
              }}
                buttonStyle={{
                  backgroundColor: "transparent",
                }}
            ...
            >
              <View style={{ paddingTop: 0, width: "100%" }}>
                <Text style={{ fontFamily: 'Inter_100Thin', fontSize: 16 }}>Email: knight@gmail.com</Text>
              </View>
              <Button
              onPress={() => {
                props.navigation.navigate("AccountEmailSetting");
                console.log("Email Setting Press!");
              }}
                buttonStyle={{
                  backgroundColor: "transparent",
                }}
            ...
            >
              <View style={{ paddingTop: 0, width: "100%" }}>
                <Text style={{ fontFamily: 'Inter_100Thin', fontSize: 16 }}>Change PIN</Text>
              </View>
              <Button
              onPress={() => {
                props.navigation.navigate("AccountPINSetting");
                console.log("PIN Setting Press!");
              }}
                buttonStyle={{
                  backgroundColor: "transparent",
                }}
            ...
            >
              <View style={{ paddingTop: 0, width: "100%" }}>
                <Text style={{ fontFamily: 'Inter_100Thin', fontSize: 16, paddingLeft: 35 }}>Use PIN On/Off</Text>
              </View>
              <Button
                buttonStyle={{
                  backgroundColor: "transparent",
